...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Все книги</div>
                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control"
                                                   id="author" name="author" maxlength="40" required>
                                        </div>
                                    </div>
                        
                                    <label for="co_author" class="col-sm-3 control-label">Соавтор</label>
                         <div class="col-sm-12">
                         <input type="text" class="form-control"
                         id="co_author" name="co_author" maxlength="40" required>
                 </div>

            <label for="title" class="col-sm-3 control-label">Название книги</label>
            <div class="col-sm-12">
                <input type="text" class="form-control"
...
$(function() {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            { data: 'co_author', name: 'co_author',orderable: false },
